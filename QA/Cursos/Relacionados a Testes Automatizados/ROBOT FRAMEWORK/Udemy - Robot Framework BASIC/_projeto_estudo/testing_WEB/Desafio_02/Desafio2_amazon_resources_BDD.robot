*** Settings ***
Documentation   Essa suite contem todas as keywords necessárias para fazer o passo a passo de cada teste case do DESAFIO 2
...             Onde criei novas keywords ao final do codigo para seguir o modelo proposto
...
### Adaptando keywords para a estrutura de BDD proposta no DESAFIO 2
